...
public class ExerciseFivePage extends BasePage {
    public ExerciseFivePage(WebDriver driver) {
        super(driver);
    }
    ...
    By subjectsContainer = By.xpath("//div[@id='subjectsContainer']/descendant::input[@type='text']");
    By hobbiesSports = By.xpath("//div[@id='hobbiesWrapper']/descendant::input[@value='1']");
    By uploadPictureButton = By.xpath("//input[@type='file']");
    By currentAddressInput = By.xpath("//textarea[@placeholder='Current Address']");
    By stateFixedbanInput = By.xpath("//div[@id='stateCity-wrapper']/descendant::input[1]");
    By SelectCity =  By.xpath("//div[@id='city']/descendant::input[1]");
